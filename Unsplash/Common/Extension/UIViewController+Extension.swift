...
extension UIViewController {
    func showAlert(title: String = Alert.Title.error,
        ...
        alert.addAction(UIAlertAction(title: Alert.ActionTitle.ok, style: .default, handler: okHandler))
        
        if okHandler != nil {
            alert.addAction(UIAlertAction(title: Alert.ActionTitle.cancel, style: .cancel))
        }
